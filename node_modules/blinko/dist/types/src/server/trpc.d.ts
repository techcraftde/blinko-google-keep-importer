...
export declare const t: {
    ...
    procedure: import("@trpc/server/unstable-core-do-not-import").ProcedureBuilder<import("./context").User | {
        id: string;
        ip: any;
        userAgent: import("bowser").Parser.ParsedResult | null;
        name: string;
    ...
    middleware: <$ContextOverrides>(fn: import("@trpc/server/unstable-core-do-not-import").MiddlewareFunction<import("./context").User | {
        id: string;
        ip: any;
        userAgent: import("bowser").Parser.ParsedResult | null;
        name: string;
        ...
        exp: number;
        iat: number;
    }, OpenApiMeta, object, $ContextOverrides, unknown>) => import("@trpc/server/unstable-core-do-not-import").MiddlewareBuilder<import("./context").User | {
        id: string;
        ip: any;
        userAgent: import("bowser").Parser.ParsedResult | null;
        name: string;
...
export declare const publicProcedure: import("@trpc/server/unstable-core-do-not-import").ProcedureBuilder<import("./context").User | {
    id: string;
    ip: any;
    userAgent: import("bowser").Parser.ParsedResult | null;
    name: string;
...
export declare const authProcedure: import("@trpc/server/unstable-core-do-not-import").ProcedureBuilder<import("./context").User | {
    id: string;
    ip: any;
    userAgent: import("bowser").Parser.ParsedResult | null;
    name: string;
    ...
    iat: number;
    ip: string | undefined;
    userAgent: import("bowser").Parser.ParsedResult | undefined;
} | {
    sub: string;
    id: string;
    name: string;
...
export declare const demoAuthMiddleware: import("@trpc/server/unstable-core-do-not-import").MiddlewareBuilder<import("./context").User | {
    id: string;
    ip: any;
    userAgent: import("bowser").Parser.ParsedResult | null;
    name: string;
...
export declare const superAdminAuthMiddleware: import("@trpc/server/unstable-core-do-not-import").MiddlewareBuilder<import("./context").User | {
    id: string;
    ip: any;
    userAgent: import("bowser").Parser.ParsedResult | null;
    name: string;
